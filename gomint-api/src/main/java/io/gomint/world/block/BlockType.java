...
public enum BlockType {
    ...
    SCAFFOLDING,
    LIGHT_BLOCK,
    PRISMARINE_SLAB, DRIED_KELP, POLISHED_BLACKSTONE_BUTTON, POLISHED_BLACKSTONE_PRESSURE_PLATE, SMITHING_TABLE, CARTOGRAPHY_TABLE, CONDUIT, STRUCTURE_VOID, UNKNOWN,
