...
public class TellCommand extends Command {
    ...
    public CommandOutput execute( CommandSender sender, String alias, Map<String, Object> arguments ) {
        ...
        String name = (sender instanceof ConsoleCommandSender) ? "CONSOLE" : ((EntityPlayer) sender).getName();

        target.sendMessage( ChatColor.GRAY + "[ " + name + " -> me] " + (String) arguments.get( "message" ) );
