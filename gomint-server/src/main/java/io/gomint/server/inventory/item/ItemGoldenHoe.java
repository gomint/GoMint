 ...
 * @version 1.0
 */
@RegisterInfo( sId = "minecraft:golden_hoe", id = 294 )
public class ItemGoldenHoe extends ItemReduceTierGolden<io.gomint.inventory.item.ItemGoldenHoe> implements io.gomint.inventory.item.ItemGoldenHoe {
