 ...
 * @version 1.0
 */
@RegisterInfo( sId = "minecraft:golden_boots", id = 317 )
public class ItemGoldenBoots extends ItemGoldenArmor implements io.gomint.inventory.item.ItemGoldenBoots {
