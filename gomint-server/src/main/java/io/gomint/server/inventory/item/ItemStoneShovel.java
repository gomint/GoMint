 ...
 * @version 1.0
 */
@RegisterInfo( sId = "minecraft:stone_shovel", id = 273 )
public class ItemStoneShovel extends ItemReduceTierStone<io.gomint.inventory.item.ItemStoneShovel> implements io.gomint.inventory.item.ItemStoneShovel {
