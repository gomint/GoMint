 ...
 * @version 1.0
 */
@RegisterInfo( sId = "minecraft:iron_helmet" )
public class ItemIronHelmet extends ItemIronArmor<io.gomint.inventory.item.ItemIronHelmet> implements io.gomint.inventory.item.ItemIronHelmet {
