...
@RegisterInfo(sId = "minecraft:double_stone_slab[stone_slab_type=stone_brick]", def = true)
@RegisterInfo(sId = "minecraft:double_stone_slab4[stone_slab_type_4=mossy_stone_brick]")
public class StoneBrickDoubleSlab extends Slab<BlockStoneBrickDoubleSlab> implements BlockStoneBrickDoubleSlab {

    public enum StoneBrickSlabTypeMagic {

        NORMAL("minecraft:double_stone_slab", "stone_brick"),
        MOSSY("minecraft:double_stone_slab4", "mossy_stone_brick");
    ...
    public BlockType blockType() {
        return BlockType.STONE_BRICK_DOUBLE_SLAB;
    }
    ...
    @Override
    public BlockStoneBrickDoubleSlab type(StoneBrickSlabType type) {
    ...
    public List<ItemStack<?>> drops(ItemStack<?> itemInHand) {
        return Collections.singletonList(ItemStoneBrickDoubleSlab.create(1).type(this.type()));
    }
