...
public class LevelEvent {
    ...
    public static final int SOUND_IGNITE = 1005;
    public static final int SOUND_GHAST = 1007;
    public static final int SOUND_GHAST_SHOOT = 1008;
    public static final int SOUND_BLAZE_SHOOT = 1009;
    ...
    public static final int SOUND_POP = 1030;
    public static final int SOUND_PORTAL = 1032;
    public static final int SOUND_ITEMFRAME_ADD_ITEM = 1040;
    public static final int SOUND_ITEMFRAME_REMOVE = 1041;
    public static final int SOUND_ITEMFRAME_PLACE = 1042;
    public static final int SOUND_ITEMFRAME_REMOVE_ITEM = 1043;
    public static final int SOUND_ITEMFRAME_ROTATE_ITEM = 1044;
    public static final int SOUND_CAMERA = 1050;
    public static final int SOUND_ORB = 1051;
    public static final int SOUND_TOTEM = 1052;
    public static final int SOUND_ARMOR_STAND_BREAK = 1060;
    public static final int SOUND_ARMOR_STAND_HIT = 1061;
    public static final int SOUND_ARMOR_STAND_FALL = 1062;
    public static final int SOUND_ARMOR_STAND_PLACE = 1063;
    ...
    public static final int CAULDRON_FILL_WATER = 3506;
    public static final int CAULDRON_TAKE_WATER = 3507;
    public static final int CAULDRON_ADD_DYE = 3508;
    public static final int CAULDRON_CLEAN_BANNER = 3509;
