...
public class SandstoneSlab extends Slab<BlockSandstoneSlab> implements BlockSandstoneSlab {
    ...
    public BlockType blockType() {
        return BlockType.SANDSTONE_SLAB;
    }

    @Override
    public BlockSandstoneSlab color(Sandcolor color) {
    ...
    @Override
    public BlockSandstoneSlab type(SandstoneSlabType type) {
        return this.change(this.color(), type);
    }

    private BlockSandstoneSlab change(Sandcolor color, SandstoneSlabType type) {
