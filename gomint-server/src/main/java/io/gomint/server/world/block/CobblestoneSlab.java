 ...
 * @version 1.0
 */
@RegisterInfo( sId = "minecraft:stone_slab[stone_slab_type=cobblestone]", def = true )
@RegisterInfo( sId = "minecraft:stone_slab2[stone_slab_type_2=mossy_cobblestone]" )
public class CobblestoneSlab extends Slab<BlockCobblestoneSlab> implements BlockCobblestoneSlab {
    ...
    public BlockType blockType() {
        return BlockType.COBBLESTONE_SLAB;
    }
    ...
    @Override
    public BlockCobblestoneSlab type(CobblestoneType type) {
